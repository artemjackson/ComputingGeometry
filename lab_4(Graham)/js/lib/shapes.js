...
function Shape() {
    ...
    this.useStyle = function (ctx) {
        ctx.fillStyle = this.resources['fill'] ? this.resources['fill'] : ctx.fillStyle;
        ctx.strokeStyle = this.resources['stroke'] ? this.resources['stroke'] : ctx.strokeStyle;
        ctx.lineWidth = this.resources['width'] ? this.resources['width'] : ctx.lineWidth;
    };
...
function Line(start, end) {
    ...
    this.render = function (ctx) {
        ...
        ctx.beginPath(this.start.x, this.start.y);
